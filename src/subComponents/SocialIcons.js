...
const Socialcons = props => {
  return (
    <Icons>
      <div>
        <a href="https://github.com/ArhamFarooqKadwani" target="_blank">
          <Github width={25} height={25} fill="white" />
        </a>
      </div>
      <div>
        <a href="https://x.com/Arham_Farooq709" target="_blank">
          <Twitter width={25} height={25} fill="white" />
        </a>
      </div>
      <div>
        <a href="https://www.linkedin.com/in/arham-farooq-b9680b25b/" target="_blank">
